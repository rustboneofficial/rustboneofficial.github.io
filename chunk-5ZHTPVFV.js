import {
  ...
  ReaderComponent,
  RouterModule
} from "./chunk-5H2O3ZAR.js";
import {
  WorkerManagementComponent,
  WorkerService
} from "./chunk-LISPRQHC.js";
import {
  BehaviorSubject,
  ChangeDetectorRef,
  CloudSaveService,
...
function AppComponent_div_2_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "NEURAL LINK REQUIRED");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p");
    \u0275\u0275text(7, "Connect to Neural Link to access all features and sync your profile.");
    \u0275\u0275elementEnd()()();
  }
}
function AppComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 9)(1, "header", 10)(2, "div", 11)(3, "span", 12);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "main", 16);
    \u0275\u0275template(13, AppComponent_div_2_div_13_Template, 8, 0, "div", 17);
    \u0275\u0275elementStart(14, "div", 18)(15, "h2");
    ...
    \u0275\u0275listener("click", function AppComponent_div_2_Template_button_click_21_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.enterNeuralLink());
    });
    \u0275\u0275elementStart(22, "span");
    \u0275\u0275text(23, "\u{1F9E0} NEURAL LINK");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "small");
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "button", 20);
    \u0275\u0275listener("click", function AppComponent_div_2_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.enterChapterNavigator());
    });
    \u0275\u0275elementStart(27, "span");
    \u0275\u0275text(28, "\u{1F4D6} ACCESS STORY FILES");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "small");
    \u0275\u0275text(30, "Browse available chapters");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "button", 20);
    \u0275\u0275listener("click", function AppComponent_div_2_Template_button_click_31_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.enterWorkerManagement());
    });
    \u0275\u0275elementStart(32, "span");
    \u0275\u0275text(33, "\u{1F477} WORKER MANAGEMENT");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "small");
    \u0275\u0275text(35, "View profile, schedule, permissions & QR code");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "button", 20);
    \u0275\u0275listener("click", function AppComponent_div_2_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.enterSystemLogs());
    });
    \u0275\u0275elementStart(37, "span");
    \u0275\u0275text(38, "\u{1F4CB} SYSTEM LOGS");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "small");
    \u0275\u0275text(40, "View application events and diagnostics");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    let tmp_1_0;
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("WORKER: ", ((tmp_4_0 = ctx_r1.workerProfile()) == null ? null : tmp_4_0.id) || "NOT CONNECTED", "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("CLEARANCE: ", ((tmp_5_0 = ctx_r1.workerProfile()) == null ? null : tmp_5_0.clearanceLevel) || "N/A", "");
    \u0275\u0275advance();
    \u0275\u0275classProp("highlight", !ctx_r1.isNeuralLinkConnected());
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r1.isNeuralLinkConnected() ? "Manage cloud sync and profile" : "Connect to unlock features");
    \u0275\u0275advance();
    \u0275\u0275property("disabled", !ctx_r1.isNeuralLinkConnected());
    \u0275\u0275advance(5);
    \u0275\u0275property("disabled", !ctx_r1.isNeuralLinkConnected());
    \u0275\u0275advance(5);
    \u0275\u0275property("disabled", !ctx_r1.isNeuralLinkConnected());
...
function AppComponent_app_chapter_navigator_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-chapter-navigator", 24);
    \u0275\u0275listener("chapterSelected", function AppComponent_app_chapter_navigator_3_Template_app_chapter_navigator_chapterSelected_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onChapterSelected($event));
    })("exitNavigation", function AppComponent_app_chapter_navigator_3_Template_app_chapter_navigator_exitNavigation_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
...
function AppComponent_app_reader_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-reader", 25);
    \u0275\u0275listener("exitReader", function AppComponent_app_reader_4_Template_app_reader_exitReader_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
...
function AppComponent_app_worker_management_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-worker-management", 26);
    \u0275\u0275listener("exitManagement", function AppComponent_app_worker_management_5_Template_app_worker_management_exitManagement_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function AppComponent_app_system_logs_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-system-logs", 27);
    \u0275\u0275listener("exitLogs", function AppComponent_app_system_logs_6_Template_app_system_logs_exitLogs_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
function AppComponent_app_neural_link_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-neural-link", 28);
    \u0275\u0275listener("exitSync", function AppComponent_app_neural_link_7_Template_app_neural_link_exitSync_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
...
var AppComponent = class _AppComponent {
  ...
  ngOnInit() {
    ...
    this.cloudSaveService.neuralLink$.subscribe((state) => {
      ...
      if (state.status === "connected" && state.operario) {
        const basicProfile = {
          id: state.operarioId || "UNKNOWN",
          name: state.operario || "Unknown Worker",
          clearanceLevel: "STANDARD",
          department: "Operations",
          role: "Operator",
          zone: 1,
          biometricHash: state.operarioId || "UNKNOWN",
        ...
        this.workerProfile.set(basicProfile);
        this.logService.logInfo("SYSTEM", "Neural Link established", "app.component", `User: ${state.operario}`);
      } else if (state.status === "disconnected") {
        this.workerProfile.set(null);
        this.logService.logWarning("SYSTEM", "Neural Link disconnected", "app.component");
      }
    });
  ...
  static {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 9, vars: 9, consts: [[1, "rustbone-terminal"], [3, "bootCompleted", 4, "ngIf"], ["class", "main-app", 4, "ngIf"], [3, "chapterSelected", "exitNavigation", 4, "ngIf"], [3, "exitReader", 4, "ngIf"], [3, "exitManagement", 4, "ngIf"], [3, "exitLogs", 4, "ngIf"], [3, "exitSync", 4, "ngIf"], [3, "bootCompleted"], [1, "main-app"], [1, "app-header"], [1, "worker-info"], [1, "worker-id"], [1, "zone"], [1, "system-status"], [1, "status-indicator"], [1, "app-content"], ["class", "neural-link-alert", 4, "ngIf"], [1, "main-menu"], [1, "menu-button", 3, "click"], [1, "menu-button", 3, "click", "disabled"], [1, "neural-link-alert"], [1, "alert-icon"], [1, "alert-content"], [3, "chapterSelected", "exitNavigation"], [3, "exitReader"], [3, "exitManagement"], [3, "exitLogs"], [3, "exitSync"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275template(1, AppComponent_app_boot_1_Template, 1, 0, "app-boot", 1)(2, AppComponent_div_2_Template, 41, 11, "div", 2)(3, AppComponent_app_chapter_navigator_3_Template, 1, 0, "app-chapter-navigator", 3)(4, AppComponent_app_reader_4_Template, 1, 0, "app-reader", 4)(5, AppComponent_app_worker_management_5_Template, 1, 0, "app-worker-management", 5)(6, AppComponent_app_system_logs_6_Template, 1, 0, "app-system-logs", 6)(7, AppComponent_app_neural_link_7_Template, 1, 0, "app-neural-link", 7);
        \u0275\u0275element(8, "app-artifact-frame");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
